    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="col-md-6">
              <div class="">
                <img
                  :src="product.image || `https://placehold.com/600x400`"
            ...
            <div class="col-md-6">
              ...
              <div class="">
                ...
                <div class="d-flex flex-wrap gap-2">
                  <span class="badge text-bg-secondary p-2" v-for="(tag, index) in product.tags" :key="index"> {{ tag }}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-footer">
        <a href="mailto:rajatsharma221098@gmail.com" class="btn btn-primary">Contact Us</a>
